...
PLANOS (a partir de R$497/mes; se o usuario quiser detalhe, sugira ver a secao de planos da pagina): Starter R$497/mes (1 profissional, 1.000 mensagens/mes); Profissional R$1.197/mes (ate 3 profissionais, 5.000 mensagens, multicanal); Enterprise R$3.490/mes (ate 10 profissionais, mensagens ilimitadas, multiunidades, marca propria). Teste gratis de 7 dias.
